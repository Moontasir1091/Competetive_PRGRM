...
//         cin >> a[i];
//         if(a[i]==1)cnt1++;
//         if(a[i] == 0) a[i] = 1; // Convert 0 to 1
//         else a[i] = -1; // Convert 1 to -1
//     }
//     if(cnt1 == n) {
//         cout << n - 1 << endl; // If all are 1s, we can flip all but one
//         return;
//     }
...
// }
// cout << cnt1 + maxSum << endl; // Maximum sum of 1s after flipping
